...
\newcommand*{\Title}{Realisierung eines einfachen Online-Shops} %Titel
\subtitle{Modul WEB05} %Untertitel
...
\begin{frame} %%Eine Folie
  \frametitle{Geschäftsmodell} %%Folientitel
...
\begin{frame} %%Eine Folie
  \frametitle{Voraussetzungen} %%Folientitel
...
\begin{frame} %%Eine Folie
  \frametitle{Realisierung des Onlineshop} %%Folientitel
  \begin{block}{Realisierung des Onlineshop}
	  \begin{itemize}
		\item OpenSource/CE Version 1.9 von Magento
